<template>
  <div class="internship_plan">
          ...
          <div class="list_c">
            <span @click="companyOpen(index)">企业</span> | <span @click="eidtOpen(index)">编辑</span> | <el-dropdown trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item><span class="stop_line" @click="stopOpen(index)">暂停</span></el-dropdown-item>
                <el-dropdown-item><span class="cancle_line" @click="deleteOpen(index)">删除</span></el-dropdown-item>
                <el-dropdown-item><span>企业名单导出</span></el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
    ...
    <add-fair :dialogFormVisible="dialogFormVisible" @closeFunc="closeFunc" :isedit="isedit" :editId="editId"></add-fair>
    <add-company :dialogTableVisible="dialogTableVisible" @closeFunc="closeFunc"></add-company>
    <tip-fair ref="tip" :dialogVisible="dialogVisible" @closeTip="closeTip"></tip-fair>
  </div>
</template>
<script>
import AddCompany from './module/AddCompany.vue'
import AddFair from './module/AddFair'
import TipFair from './module/TipFair'
export default {
  components: {
    AddFair,
    AddCompany,
